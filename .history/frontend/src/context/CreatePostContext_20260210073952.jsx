                ...
                <div className="home-create-user-row">
                  <div className="home-create-user-avatar">
                    {(() => {
                      ...
                      // 1. Try avatar from state
                      let displayAvatar = user?.avatar || user?.profile_image

                      // 2. If no avatar in state, try localStorage for active profile
                      ...
                      // 3. If still no avatar, try localStorage for user ID
