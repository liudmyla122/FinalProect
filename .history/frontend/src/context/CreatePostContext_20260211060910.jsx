  ...
  useEffect(() => {
    ...
    const checkActiveProfile = () => {
      ...
      if (String(currentUserId) !== String(activeId)) {
        console.log(
          '🔄 Account switch detected while modal open - updating user data'
        )
              ...
              <div className="home-create-modal-right">
                <div className="home-create-user-row">
                  ...
                  <div className="home-create-username">
                    {(() => {
                      // Try to get username from profiles array in localStorage
                      ...
                      // Use username from profiles array, fall back to user state
                      const nick =
                        (
                          profileFromList?.username ||
                      ...
                      console.log(
                        ...
                        nick,
                        'from profile:',
                        profileFromList?.username || 'NOT FOUND'
                      )
