  ...
  useEffect(() => {
    ...
    const loadPosts = async () => {
      try {
        ...
        console.warn(
          'Ошибка при загрузке постов по profileId, пробуем без фильтра:',
          error
        )
      }
                ...
                <div key={post.id} className="post-item-wrapper">
                  ...
                  >
                    ...
                    <div className="post-card-bottom">
                      ...
                      <div
                        className="post-stats post-stats-on-card"
              ...
              <div className="profile-post-modal-side">
                ...
                <div className="profile-post-modal-footer">
                  ...
                  <div className="profile-post-modal-stats">
                    ...
                    <span
                      className="profile-post-modal-views"
                      title="Просмотры"
                    >
                      {selectedPost.viewsCount || 0}
                    </span>
                    <span
                      className="profile-post-modal-comments-count"
                      title="Комментарии"
                    >
