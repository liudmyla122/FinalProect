...
const Home = () => {
  ...
  useEffect(() => {
    ...
    console.log('🔑 Токен из localStorage:', token ? 'есть' : 'нет', token?.substring(0, 20) + '...')
    if (!token) {
          ...
          if (serverProfiles.length > 0) {
            ...
            if (activeId) {
              ...
              const profileUser = {
                ...activeProfile,
                dbId: currentUser.id,
                email: currentUser.email, // Сохраняем основные данные
            ...
            // Нет профилей, используем основного пользователя
            ...
            <Link to="/profile" className="home-sidebar-current-user">
                ...
                {user.isActiveProfile && (
                  <div className="home-sidebar-profile-indicator">
                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                      <circle cx="6" cy="6" r="6" fill="#00A9BE"/>
              ...
              <div className="home-sidebar-current-info">
                ...
                <span className="home-sidebar-current-username">
                  {user.isActiveProfile ? `@${user.username}` : (user.email || '')}
                </span>
              </div>
            </Link>
          )}
